...
public class CustomExpandableList extends BaseExpandableListAdapter
{
    ...
    {
        System.out.println("::: get group count : " + this.listTitle.size());
    ...
    {
        System.out.println("::: get child count : " + this.listDetail.get(this.listTitle.get(groupPosition)).size());
    ...
    {
        System.out.println(":::get group: " + this.listTitle.get(groupPosition));
    ...
    {
        System.out.println("::: get child : " + this.listDetail.get(this.listTitle.get(groupPosition)).get(childPosition));
